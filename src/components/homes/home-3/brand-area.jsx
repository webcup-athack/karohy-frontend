...
const brand_contents = {
  ...
  brands: [
    ...
    '/assets/img/brand/brand-8.png',
    '/assets/img/brand/brand-9.png',
    '/assets/img/brand/brand-10.png',
    '/assets/img/brand/brand-11.png',
    '/assets/img/brand/brand-12.png',
    '/assets/img/brand/brand-13.png',
    '/assets/img/brand/brand-14.png',
  ]
}
