...
const contents = {
  ...
  project_items: [
    { subtitle: 'Business', title: 'Business Consulting', img: '/assets/img/project/project-5.1.jpg' },
    { subtitle: 'Banking', title: 'Finance & Bank', img: '/assets/img/project/project-5.2.jpg' },
    { subtitle: 'Design', title: 'Branding Design', img: '/assets/img/project/project-5.3.jpg' },
    { subtitle: 'Business', title: 'Business Consulting', img: '/assets/img/project/project-5.2.jpg' },
  ]
}
